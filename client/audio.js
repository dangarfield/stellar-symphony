...
const loadSampler = async (type, name) => {
  return new Promise(resolve => {
    const melodyNotes = {
      C5: `${type} - ${name} - C5.mp3`,
      Db5: `${type} - ${name} - Db5.mp3`,
      D5: `${type} - ${name} - D5.mp3`,
      Eb5: `${type} - ${name} - Eb5.mp3`,
      E5: `${type} - ${name} - E5.mp3`,
      F5: `${type} - ${name} - F5.mp3`,
      Gb5: `${type} - ${name} - Gb5.mp3`,
      G5: `${type} - ${name} - G5.mp3`,
      Ab5: `${type} - ${name} - Ab5.mp3`,
      A5: `${type} - ${name} - A5.mp3`,
      Bb5: `${type} - ${name} - Bb5.mp3`,
      B5: `${type} - ${name} - B5.mp3`
    }
    const chordsNotes = {
      C3: `${type} - ${name} - C3.mp3`,
      Db3: `${type} - ${name} - Db3.mp3`,
      D3: `${type} - ${name} - D3.mp3`,
      Eb3: `${type} - ${name} - Eb3.mp3`,
      E3: `${type} - ${name} - E3.mp3`,
      F3: `${type} - ${name} - F3.mp3`,
      Gb3: `${type} - ${name} - Gb3.mp3`,
      G3: `${type} - ${name} - G3.mp3`,
      Ab3: `${type} - ${name} - Ab3.mp3`,
      A3: `${type} - ${name} - A3.mp3`,
      Bb3: `${type} - ${name} - Bb3.mp3`,
      B3: `${type} - ${name} - B3.mp3`,

      C4: `${type} - ${name} - C4.mp3`,
      Db4: `${type} - ${name} - Db4.mp3`,
      D4: `${type} - ${name} - D4.mp3`,
      Eb4: `${type} - ${name} - Eb4.mp3`,
      E4: `${type} - ${name} - E4.mp3`,
      F4: `${type} - ${name} - F4.mp3`,
      Gb4: `${type} - ${name} - Gb4.mp3`,
      G4: `${type} - ${name} - G4.mp3`,
      Ab4: `${type} - ${name} - Ab4.mp3`,
      A4: `${type} - ${name} - A4.mp3`,
      Bb4: `${type} - ${name} - Bb4.mp3`,
      B4: `${type} - ${name} - B4.mp3`
    }
    const urls = type === 'Melody' ? melodyNotes : chordsNotes
    const sampler = new Sampler({
      urls: urls,
      baseUrl: `sounds/${type}/${name}/`,
      onload: () => {
  ...
  if (toneData.type === 'scale') {
    ...
    if (toneData.url) {
      ...
      for (const track of toneData.song) {
        ...
        let sampler
        switch (track.type) {
          case 'Chords': sampler = await loadSampler('Chords', 'Nasty Tines'); break
          case 'Chords Drone': sampler = await loadSampler('Chords', 'Circular Mmms'); break
          case 'Melody 1': sampler = await loadSampler('Melody', 'Soft Piano'); break
          case 'Melody 2': sampler = await loadSampler('Melody', 'Earth Sign'); break
          case 'Root Bass': sampler = await loadSampler('Chords', 'Space Pluck 2'); break
          case 'High Notes': sampler = await loadSampler('Melody', 'Ghost Hand Bells'); break
          case 'Picking': sampler = await loadSampler('Chords', 'Sustain Ahhs'); break
          case 'Fast Arpeggio': sampler = await loadSampler('Chords', 'Plucks'); break
          case 'Low Drone': sampler = await loadSampler('Chords', 'The Lightkeeper'); break
          default: sampler = await loadSampler('Chords', 'Floe'); break
        }
